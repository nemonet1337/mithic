...
/// プロセス全体で共有する I18n (FTL は起動時に 1 度だけパース)。
/// concurrent FluentBundle は Send + Sync。
pub static I18N: LazyLock<I18n> = LazyLock::new(I18n::new);
...
impl I18n {
    ...
    pub fn new() -> Self {
        ...
        let mut ja_bundle = FluentBundle::new_concurrent(vec![ja_lang]);
        ja_bundle
