...
use shared::{LoginRequest, RefreshRequest, SignupRequest, TokenPair};

use crate::auth::generate_jwt;
use crate::db::queries::{get_actor_by_id, update_actor_token};
...
async fn token_pair(state: &AppState, actor: &crate::models::actor::Actor) -> Result<TokenPair> {
